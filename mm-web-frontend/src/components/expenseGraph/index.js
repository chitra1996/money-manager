    ...
    return (
      ...
      >
        ...
        >
          ...
          <div
            style={{ position: "absolute", fontSize: 18, textAlign: "center" }}
          >
            <span style={{ color: "#7B2DE4" }}>₹40000</span> <br />
            of
            <br />
            <span style={{ color: "#02DB9B" }}> ₹58000</span>
          </div>
        </div>
