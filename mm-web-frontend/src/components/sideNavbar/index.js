      ...
      >
        ...
        <nav style={{ width: "100%" }}>
          <ul style>
            <Link to="/">
              <li
                style={this.getListStyle("taskList")}
                onClick={() => {
            ...
            <Link to="/screen1">
              <li
                style={this.getListStyle("screenOne")}
                onClick={() => {
            ...
            <Link to="/screen2">
              <li
                style={this.getListStyle("screenTwo")}
                onClick={() => {
            ...
            <Link to="/screen3">
              <li
                style={this.getListStyle("screenThree")}
                onClick={() => {
        ...
        <div
          ...
          onClick={() => {
            ...
            this.props.history.push("/login", [
              "I am a great prop being passed from the router",
            ]);
          }}
        >
          <div
